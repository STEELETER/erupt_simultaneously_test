...
webkiturl='http://www.zhongcunsoft.com'
...
#-----------------------------增加双击top图最大化和恢复的功能
    def mouseDoubleClickEvent(self,w):
        ...
        global imax
        if imax==0:
            QUnFrameWindow._changeNormalButton(window)
        elif imax==1:
            QUnFrameWindow._changeMaxButton(window)
...
# ---------用户信息区框架及里面所有内容
            ...
            self.mijilab.setStyleSheet("QTitleLabel{border-width: 0px 0px 0px 0px;border-radius:3px;border-color:#b90101; font-size:12px;border-style: solid;background-color: #b90101;}")
